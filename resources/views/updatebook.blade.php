...
<body>
    <div class="container">
        <p class="h2 text-center">GÜNCELLE</p>
        <form action="{{ route('update', $book->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="preview text-center">
                <img class="preview-img"
                    src="{{ $book->image_url ? $book->url : 'https://openclipart.org/image/400px/275692' }}"
                    width="200" height="200" />
                <div class="browse-button" style="overflow: hidden">
                    <x-fileicon-photorec style="height: 200 ; width:200" /> {{-- resim ekleme ikonu --}}
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="page_number" value="{{ $book->page_number }}">
                <span class="Error"></span>
            </div>
            <div class="form-group">
                <label>Yayın Tarihi:</label>
                <input type="text" id="datepicker" size="30" class="form-control" name="published_date"
                    value="{{ \Carbon\Carbon::parse($book->published_date)->format('d/m/Y') }}">
                <span class="Error"></span>
            </div>
            <div class="form-group">
